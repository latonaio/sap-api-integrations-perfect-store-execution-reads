...
func main() {
	...
	inoutSDC := fr.ReadSDC("./Inputs/SDC_Perfect_Store_Execution_ Store_Valuation_Collection_sample.json")
	...
	caller.AsyncGetPerfectStoreExecution(
		inoutSDC.StoreValuationCollection.ObjectID,
		accepter,
	)
}
